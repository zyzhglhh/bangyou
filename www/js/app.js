...
.config(['$stateProvider', '$urlRouterProvider', '$urlMatcherFactoryProvider', '$locationProvider', '$provide', 'CONFIG', function ($stateProvider, $urlRouterProvider, $urlMatcherFactoryProvider, $locationProvider, $provide, CONFIG) {
    ...
    $stateProvider
        ...
        .state('user.ydorder', {    
            ...
            views: {
                'userHome': {
                    templateUrl: 'partials/user/ydorder.html',
                    controller: 'userYdOrder'
                }
            }
        })
        ...
        .state('user.yisheng', {    
            ...
            views: {
                'userHome': {
                    templateUrl: 'partials/user/yisheng.html',
                    controller: 'userYisheng'
                }
            }
        })
        .state('user.outlineuserJiahao', {    
            url: '/outline',
            views: {
                'userHome': {
                    templateUrl: 'partials/user/outline.html',
                    controller: 'userOutline'
                }
            }
        })
        .state('user.jiahao', {    
        ...
        .state('user.guahao', {    
            ...
            views: {
                'userHome': {
                    templateUrl: 'partials/user/guahao.html',
                    controller: 'userGuahao'
                }
            }
        })
